Algoritmo verificarfechajunior
    ...
    Segun mes Hacer
            Si (dia >= 1) Y (dia <= 31) Entonces Escribir "La fecha es válida.";Sino Escribir "El dia ingresado no es válido.";FinSi
            Si (dia >= 1) Y (dia <= 30) Entonces Escribir "La fecha es válida.";Sino Escribir "El dia ingresado no es válido.";FinSi
            Si ((ano MOD 4 = 0) Y (ano MOD 100 <> 0)) O (ano MOD 400 = 0) Entonces
                Si (dia >= 1) Y (dia <= 29) Entonces Escribir "La fecha es válida."; Sino Escribir "El dia ingresado no es válido.";FinSi
            Sino
